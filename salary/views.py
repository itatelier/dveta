...
class SalaryMonthAnalyzeOfficeView(UpdateView, SalaryMonthSummaryView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        if hasattr(self.object, 'races_done'):
            ...
            context_data['accruals_list_penalty_and_bonus'] = SalaryFlow.objects\
                .filter(operation_type__in=[2, 3], employee=self.driver_pk, year=self.report_month_dt.year,month=self.report_month_dt.month)\
