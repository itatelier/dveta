...
-- ----------------------------
INSERT INTO `auth_user` VALUES ('1', 'pbkdf2_sha256$20000$7oOutS08fC2d$SvYR9XAaDGjHfrVmGDHBHZCj04KdYRaVC22XfUJGq/U=', '2015-12-10 00:21:23', '1', 'root', '', '', 'nikita@itatelier.ru', '1', '1', '2015-11-29 16:37:00');
...
-- ----------------------------
-- Table structure for company_attraction_source
-- ----------------------------
DROP TABLE IF EXISTS `company_attraction_source`;
CREATE TABLE `company_attraction_source` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of company_attraction_source
-- ----------------------------
INSERT INTO `company_attraction_source` VALUES ('1', 'Интернет сайт');
INSERT INTO `company_attraction_source` VALUES ('2', 'Реклама в газете');
INSERT INTO `company_attraction_source` VALUES ('3', 'Инофрмация от знакомых');
...
INSERT INTO `django_content_type` VALUES ('7', 'dummyapp', 'dummycompanies');
...
-- ----------------------------
INSERT INTO `django_session` VALUES ('7nf4sg90x3ab6wsdagiqyfr45xnl690p', 'YjEzMDk1NGZiYmRkNGNiN2RhMjMyNGQzMGFmMTgwNzIyZDI4MzA1Mjp7Il9hdXRoX3VzZXJfaGFzaCI6IjlhMzllNGZkMmQxYjYxNmQzMTBlNzY1OWZkMDZjN2RmNDM2NzI5OWQiLCJfYXV0aF91c2VyX2lkIjoiMSIsIl9hdXRoX3VzZXJfYmFja2VuZCI6ImRqYW5nby5jb250cmliLmF1dGguYmFja2VuZHMuTW9kZWxCYWNrZW5kIn0=', '2015-12-24 00:21:23');
...
INSERT INTO `django_session` VALUES ('hkikiclp2o6j8tetjhbxf209z1dr96do', 'ZTU4NjUzNDBhZmY4ZTcxMWRiNjYyMDE4NWNjMTNlNTcxYjQ4YjFhMjp7Il9hdXRoX3VzZXJfaGFzaCI6IjlhMzllNGZkMmQxYjYxNmQzMTBlNzY1OWZkMDZjN2RmNDM2NzI5OWQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=', '2015-12-20 11:23:36');
INSERT INTO `django_session` VALUES ('oxtnx4uuv5xuoxu326ufqmfwqm07yjhw', 'ZTU4NjUzNDBhZmY4ZTcxMWRiNjYyMDE4NWNjMTNlNTcxYjQ4YjFhMjp7Il9hdXRoX3VzZXJfaGFzaCI6IjlhMzllNGZkMmQxYjYxNmQzMTBlNzY1OWZkMDZjN2RmNDM2NzI5OWQiLCJfYXV0aF91c2VyX2JhY2tlbmQiOiJkamFuZ28uY29udHJpYi5hdXRoLmJhY2tlbmRzLk1vZGVsQmFja2VuZCIsIl9hdXRoX3VzZXJfaWQiOiIxIn0=', '2015-12-17 21:55:07');
INSERT INTO `django_session` VALUES ('pxzbafzipp4fjkjvnm896gc38lppmoxz', 'YjEzMDk1NGZiYmRkNGNiN2RhMjMyNGQzMGFmMTgwNzIyZDI4MzA1Mjp7Il9hdXRoX3VzZXJfaGFzaCI6IjlhMzllNGZkMmQxYjYxNmQzMTBlNzY1OWZkMDZjN2RmNDM2NzI5OWQiLCJfYXV0aF91c2VyX2lkIjoiMSIsIl9hdXRoX3VzZXJfYmFja2VuZCI6ImRqYW5nby5jb250cmliLmF1dGguYmFja2VuZHMuTW9kZWxCYWNrZW5kIn0=', '2015-12-19 13:37:18');
...
CREATE TABLE `dummy_companies` (
  ...
  PRIMARY KEY (`id`),
  KEY `org_types_id` (`org_type_id`),
  KEY `rel_types_id` (`rel_type_id`),
  KEY `status_id` (`status_id`),
  CONSTRAINT `dummy_companies_ibfk_1` FOREIGN KEY (`org_type_id`) REFERENCES `company_org_types` (`id`),
  CONSTRAINT `dummy_companies_ibfk_2` FOREIGN KEY (`rel_type_id`) REFERENCES `company_rel_types` (`id`),
...
-- ----------------------------
INSERT INTO `dummy_companies` VALUES ('101', 'Вика корп', 'auctor, nunc nulla vulputate dui, nec tempus mauris erat', 'odio vel est', '2', '3', '4', '2015-09-26 10:14:43', '2015-09-12 19:51:44', '78');
